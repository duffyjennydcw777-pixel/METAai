...
|---|----------|----------|-------------|-----|
| 1 | 🔴 CRITICAL | Code Review | Небезопасное кэширование токенов по усеченному ключу (первые | — |
| 2 | 🔴 CRITICAL | Code Review | Отсутствие потокобезопасности при работе с кэшем токенов в м | — |
| 3 | 🔴 CRITICAL | Code Review | Отсутствие проверки длины и формата ключей шифрования может  | — |
| 4 | 🔴 CRITICAL | Code Review | Нет обработки ошибок при декодировании/кодировании в методах | — |
